...
const char *Acelx2 = "IoT/ACX2";
const char *Acely2 = "IoT/ACY2";
const char *Acelz2 = "IoT/ACZ2";
const char *Girox2 = "IoT/GYX2";
const char *Giroy2 = "IoT/GYY2";
const char *Giroz2 = "IoT/GYZ2";
...
tiempoAnterior = tiempoActual; 
  ...
  if (currentMillis - previousMillis >= 200) { //envia la temperatura cada 10 segundos
    ...
    itoa( AcX2,AcX_char2,10);
    Serial.println("Enviando X: [" +  String(AcX2) + "] " );
    client.publish(Acelx2, AcX_char2);

    strtemp.toCharArray(valueStr, 15);
    itoa( AcY2,AcY_char2,10);
    Serial.println("Enviando  Y: [" +  String(AcY2) + "] " );
    client.publish(Acely2, AcY_char2);

    strtemp.toCharArray(valueStr, 15);
    itoa( AcZ2,AcZ_char2,10);
    Serial.println("Enviando  Z: [" +  String(AcY2) + "] " );
    client.publish(Acelz2, AcZ_char2);   
   
    strtemp.toCharArray(valueStr, 15);
    itoa( GyX2,GyX_char2,10);
    Serial.println("Enviando  Z: [" +  String(GyX2) + "] " );
    client.publish(Girox2, GyX_char2); 

    strtemp.toCharArray(valueStr, 15);
    itoa( GyY2,GyY_char2,10);
    Serial.println("Enviando  Z: [" +  String(GyY2) + "] " );
    client.publish(Giroy2, GyY_char2);  

    strtemp.toCharArray(valueStr, 15);
    itoa( GyZ2,GyZ_char2,10);
    Serial.println("Enviando  Z: [" +  String(GyZ2) + "] " );
    client.publish(Giroz2, GyZ_char2);   
